...
Group-like structures, studied in the field of abstract algebra, can be thought of to be generated by varying which ones from a bunch of laws or axioms we choose to apply i.e. `totality`, `associativity`, `identity`, `inverse` and `commutativity`.
